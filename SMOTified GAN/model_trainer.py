...
class train_discriminator():
  ...
  def __call__(self):
    ...
    real_targets = torch.full_like(real_preds, self.minority_class, device=self.device)
    ...
    fake_targets = torch.full_like(fake_preds, self.majority_class, device=self.device)
...
class train_generator():
    ...
    def __call__(self):
        ...
        targets = torch.full_like(preds, self.minority_class, device=self.device)
